...
const sheetVariants = cva(
  "fixed z-[10015] gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
...
interface SheetContentProps
  ...
  /**
   * Styles for the backdrop. Sheets sit BELOW dialogs by default, which is
   * right until a sheet is opened from inside one — then it and its backdrop
