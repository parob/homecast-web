...
const CHAR_LABELS: Record<string, string> = {
  ...
  target_air_purifier_state: 'Purifier Mode',
  target_humidifier_dehumidifier_state: 'Humidifier Mode',
  ...
  security_system_target_state: 'Security State',
  security_system_current_state: 'Security State',
  smoke_detected: 'Smoke Detected',
  carbon_monoxide_detected: 'CO Detected',
  carbon_dioxide_level: 'CO₂ Level',
  carbon_dioxide_peak_level: 'CO₂ Peak',
  carbon_monoxide_level: 'CO Level',
  pm2_5_density: 'PM2.5',
  pm10_density: 'PM10',
  voc_density: 'VOC Level',
