...
import { Lightbulb, Lock, Smartphone, Cloud, Globe, ArrowRight, Bell, Laptop, Thermometer } from 'lucide-react';
        ...
        <section className="w-full pt-10 pb-24 px-6 relative">
          ...
          <div className="relative mx-auto max-w-4xl text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              The Homecast Relay connects to Apple Home and sends your device data to homecast.cloud. Run the relay on your own Mac, or let us host it for you.
            </p>
          </div>
