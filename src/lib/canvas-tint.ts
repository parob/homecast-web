...
/** Browser chrome and the native backdrop use the same wallpaper colour.
 * Re-exposing the top sample to the whole image and then lifting it towards
 * white made a dark teal wallpaper turquoise in Safari. Keep the native
 * reference: only the user's brightness setting changes the sampled colour.
 */
